...
const u32 gTMHMLearnsets[][2] =
{
    ...
    [SPECIES_CLOBBOPUS] = TMHM_LEARNSET(TMHM(TM01_FOCUS_PUNCH)
                      | TMHM(TM03_WATER_PULSE)
                      | TMHM(TM08_BULK_UP)
                      | TMHM(TM10_HIDDEN_POWER)
                      | TMHM(TM12_TAUNT)
    ...
    [SPECIES_GRAPPLOCT] = TMHM_LEARNSET(TMHM(TM01_FOCUS_PUNCH)
                      | TMHM(TM03_WATER_PULSE)
                      | TMHM(TM08_BULK_UP)
                      | TMHM(TM10_HIDDEN_POWER)
                      | TMHM(TM12_TAUNT)
    ...
    [SPECIES_REGIELEKI] = TMHM_LEARNSET(TMHM(TM10_HIDDEN_POWER)
                      | TMHM(TM15_HYPER_BEAM)
                      | TMHM(TM16_LIGHT_SCREEN)
                      | TMHM(TM17_PROTECT)
                      | TMHM(TM18_RAIN_DANCE)
