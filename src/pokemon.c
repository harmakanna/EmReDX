...
static const u16 sSpeciesToHoennPokedexNum[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_MAROWAK_ALOLAN - 1] = HOENN_DEX_MAROWAK,
    ...
    [SPECIES_VULPIX_ALOLAN - 1] = HOENN_DEX_VULPIX,
    SPECIES_TO_HOENN(NINETALES),
    [SPECIES_NINETALES_ALOLAN - 1] = HOENN_DEX_NINETALES,
    ...
    [SPECIES_ORICORIO_POM_POM - 1] = HOENN_DEX_ORICORIO,
    [SPECIES_ORICORIO_PAU - 1] = HOENN_DEX_ORICORIO,
    [SPECIES_ORICORIO_SENSU - 1] = HOENN_DEX_ORICORIO,
