...
const u8 gText_EnergyPowder50[] = _("ENERGYPOWDER{CLEAR_TO 114}{SIZE 0}50");
const u8 gText_EnergyRoot80[] = _("ENERGY ROOT{CLEAR_TO 114}{SIZE 0}80");
const u8 gText_HealPowder50[] = _("HEAL POWDER{CLEAR_TO 114}{SIZE 0}50");
const u8 gText_RevivalHerb300[] = _("REVIVAL HERB{CLEAR_TO 108}{SIZE 0}300");
const u8 gText_Protein1000[] = _("PROTEIN{CLEAR_TO 99}{SIZE 0}1,000");
const u8 gText_Iron1000[] = _("IRON{CLEAR_TO 99}{SIZE 0}1,000");
const u8 gText_Carbos1000[] = _("CARBOS{CLEAR_TO 99}{SIZE 0}1,000");
const u8 gText_Calcium1000[] = _("CALCIUM{CLEAR_TO 99}{SIZE 0}1,000");
const u8 gText_Zinc1000[] = _("ZINC{CLEAR_TO 99}{SIZE 0}1,000");
const u8 gText_HPUp1000[] = _("HP UP{CLEAR_TO 99}{SIZE 0}1,000");
const u8 gText_PPUp3000[] = _("PP UP{CLEAR_TO 99}{SIZE 0}3,000");
...
const u8 gText_ColorLightShadowDarkGray[] = _("{COLOR LIGHT_GREY}{SHADOW DARK_GREY}");
