...
#define AI_SCRIPT_DO_NOT_SWITCH       (1 << 10) //Prevents switching in all circumstances
#define AI_SCRIPT_PRESERVE_ORDER      (1 << 11) //When a Pokemon faints, they send out the next pokemon they have in order
